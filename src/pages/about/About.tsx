	...
	<div>
		...
		<div className="flex flex-wrap lg:flex-nowrap gap-[20px] p-[20px]">
			<Card className="flex flex-wrap p-[20px] justify-center gap-[20px] bg-[#8DA9C4] w-full lg:w-[300px] h-fit shrink-0">
				<img className="w-[150px] h-[150px] rounded-full" src={new URL(`/src/assets/author/${author.picture}`, import.meta.url).toString()} alt={author.name} />
				<div>
					...
					<div className="flex gap-[20px] mt-[10px] text-[36px] justify-evenly">
						...
						<Link to={new URL(`/src/assets/author/${author.resume}`, import.meta.url).toString()} className="border-black border-[2px] mt-[5px] p-[10px] h-[40px] leading-[15px] rounded-[5px] text-[16px]" target="_blank" download>
							Resume
						</Link>
					</div>
				</div>
